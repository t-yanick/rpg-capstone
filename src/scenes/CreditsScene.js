...
export default class CreditsScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.madeByText = this.add.text(0, 0, 'Created By: Tazoh Yanick', { fontSize: '26px', fill: '#fff' });
    this.contactText = this.add.text(0, 0, 'tyankee15@gmail.com', { fontSize: '18px', fill: '#32a852' });
    this.openText = this.add.text(0, 0,
      'Special thanks to OpenGameArt Developers'
